...
<section class="section blog-wrap">
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="<?php echo get_template_directory_uri(); ?>/images/blog/blog-1.jpg" alt="" class="img-fluid ">
			</div>
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="<?php echo get_template_directory_uri(); ?>/images/blog/blog-2.jpg" alt="" class="img-fluid">
			</div>
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="<?php echo get_template_directory_uri(); ?>/images/blog/blog-4.jpg" alt="" class="img-fluid">
			</div>
