	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<img src="<?php echo get_template_directory_uri(); ?>/images/about/sign.png" alt="" class="img-fluid">
			</div>
		</div>
	</div>
</section>
...
<section class="fetaure-page ">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="<?php echo get_template_directory_uri(); ?>/images/about/about-2.jpg" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="<?php echo get_template_directory_uri(); ?>/images/about/about-3.jpg" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item">
					<img src="<?php echo get_template_directory_uri(); ?>/images/about/about-4.jpg" alt="" class="img-fluid w-100">
		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="<?php echo get_template_directory_uri(); ?>/images/team/1.jpg" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="<?php echo get_template_directory_uri(); ?>/images/team/2.jpg" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="<?php echo get_template_directory_uri(); ?>/images/team/3.jpg" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block">
					<img src="<?php echo get_template_directory_uri(); ?>/images/team/4.jpg" alt="" class="img-fluid w-100">
